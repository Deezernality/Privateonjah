--GUI MADE BY OLIVEREIN THUG CORPORATION.......... FUCK YOU RVVZ (ROMAN TROTMAN XD) FOR BANNING MY 3K SUBS YOUTUBE CHANNEL!! 
--fart
--crim start
...
do
    ...
    menu = library.new([[oliverein poop gui  <font color="rgb(78, 93, 234)">v2</font>]], "nemv2\\")
    local tabs = {
